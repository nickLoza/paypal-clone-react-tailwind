...
function MobileMenu() {
	...
	return (
		<div className={`fixed lg:hidden z-[500] left-0 top-0 w-[300px] h-full text-[#D1F1FF] font-semibold bg-[#142C8E] transition duration-300 ${isMenuOpen? "translate-x-0" : "translate-x-[-382px]"}`}>
